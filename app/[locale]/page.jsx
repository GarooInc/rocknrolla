    ...
    <main className='min-h-screen bg-white'>
      ...
      <div className='flex md:flex-row flex-col w-full justify-center items-stretch md:gap-10'>
        <div className='w-full flex flex-col md:gap-10'>
          ...
          <Banner title={t('home:last_work')} button={t('home:view')} image={'/assets/images/home/fresh.webp'} link={'/project/y-si-en-vez-de-hacer-un-jingle-creamos-la-cancion-del-fiambre-vaojkc81k2wc1b7'} />
