...
import NonNegotiables from '@/components/NonNegotiables/NonNegotiables'
import LineTitle from '@/components/LineTitle/LineTitle'
import Footer from '@/components/Footer/Footer'
import LineButton from '@/components/LineButton/LineButton'


const namespaces = ['non-negotiable', 'general', 'navBar']
    ...
    return (
        ...
        <div className='min-h-screen bg-white'>
            ...
            <div className='md:pt-24 pt-10 pb-40 md:px-0 px-8 gap-10 flex flex-col relative items-center'>
                <LineTitle text={t('non-negotiable:non_negotiable_title')} secondary />
                <NonNegotiables />
