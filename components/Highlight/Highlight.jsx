...
const Highlight = ({ img, title }) => {
  return (
    <div
      ...
      className='highlight bg-cover bg-center bg-no-repeat md:flex-grow md:h-full h-60 flex items-end justify-end relative md:w-full w-1/2 transition-transform duration-500 ease-in-out transform hover:scale-105 cursor-pointer hover:z-10'
    >
